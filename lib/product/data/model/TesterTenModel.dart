...
class TesterTenModel  {
  ...
  TesterTenModel.fromJson(dynamic json) {
    _kind = json['kind'];
  ...
  num? _totalItems;
  List<Items>? _items;
TesterTenModel copyWith({  String? kind,
  num? totalItems,
  List<Items>? items,
}) => TesterTenModel(  kind: kind ?? _kind,
...
/// smallThumbnail : "http://books.google.com/books/content?id=6sXACwAAQBAJ&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api"
/// thumbnail : "http://books.google.com/books/content?id=6sXACwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api"
